...
.method private static synthetic $values()[Lio/sentry/MeasurementUnit$Duration;
    ...
    new-array v0, v0, [Lio/sentry/MeasurementUnit$Duration;

    .line 26
    sget-object v1, Lio/sentry/MeasurementUnit$Duration;->NANOSECOND:Lio/sentry/MeasurementUnit$Duration;
    ...
    sget-object v1, Lio/sentry/MeasurementUnit$Duration;->SECOND:Lio/sentry/MeasurementUnit$Duration;

    const/4 v2, 0x3

    aput-object v1, v0, v2

    sget-object v1, Lio/sentry/MeasurementUnit$Duration;->MINUTE:Lio/sentry/MeasurementUnit$Duration;

    const/4 v2, 0x4

    aput-object v1, v0, v2

    sget-object v1, Lio/sentry/MeasurementUnit$Duration;->HOUR:Lio/sentry/MeasurementUnit$Duration;

    const/4 v2, 0x5

    aput-object v1, v0, v2

    sget-object v1, Lio/sentry/MeasurementUnit$Duration;->DAY:Lio/sentry/MeasurementUnit$Duration;

    const/4 v2, 0x6

    aput-object v1, v0, v2

    sget-object v1, Lio/sentry/MeasurementUnit$Duration;->WEEK:Lio/sentry/MeasurementUnit$Duration;
