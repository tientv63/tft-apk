...
.method static synthetic lambda$maybeUpdateBaggage$3(Lio/sentry/SentryOptions;Lio/sentry/Scope;Lio/sentry/PropagationContext;)V
    .locals 2
    ...
    .line 85
    invoke-virtual {v0, p1, p0}, Lio/sentry/Baggage;->setValuesFromScope(Lio/sentry/Scope;Lio/sentry/SentryOptions;)V
...
.method static synthetic lambda$startNewTrace$0(Lio/sentry/Scope;Lio/sentry/PropagationContext;)V
    .locals 0
    ...
    invoke-virtual {p0, p1}, Lio/sentry/Scope;->setPropagationContext(Lio/sentry/PropagationContext;)V

    return-void
.end method

.method static synthetic lambda$startNewTrace$1(Lio/sentry/Scope;)V
    .locals 1

    .line 20
    new-instance v0, Lio/sentry/util/TracingUtils$$ExternalSyntheticLambda0;

    invoke-direct {v0, p0}, Lio/sentry/util/TracingUtils$$ExternalSyntheticLambda0;-><init>(Lio/sentry/Scope;)V

    invoke-virtual {p0, v0}, Lio/sentry/Scope;->withPropagationContext(Lio/sentry/Scope$IWithPropagationContext;)Lio/sentry/PropagationContext;

    return-void
.end method

.method static synthetic lambda$trace$2(Lio/sentry/util/TracingUtils$PropagationContextHolder;Lio/sentry/SentryOptions;Lio/sentry/Scope;)V
    .locals 0

    .line 53
    invoke-static {p2, p1}, Lio/sentry/util/TracingUtils;->maybeUpdateBaggage(Lio/sentry/Scope;Lio/sentry/SentryOptions;)Lio/sentry/PropagationContext;
...
.method public static maybeUpdateBaggage(Lio/sentry/Scope;Lio/sentry/SentryOptions;)Lio/sentry/PropagationContext;
    .locals 1

    .line 77
    new-instance v0, Lio/sentry/util/TracingUtils$$ExternalSyntheticLambda2;

    invoke-direct {v0, p1, p0}, Lio/sentry/util/TracingUtils$$ExternalSyntheticLambda2;-><init>(Lio/sentry/SentryOptions;Lio/sentry/Scope;)V
